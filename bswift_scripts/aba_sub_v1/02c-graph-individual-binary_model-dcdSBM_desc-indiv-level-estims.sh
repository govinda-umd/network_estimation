...
#SBATCH --output=./log/indiv-lvl-estims_dcdSBM_%a.out
...
FORCE_NITER=${9} # 100,000
SAMPLES=${10} # 1000
GAMMA=${11} # 2.0 used only in mod.max.state
SEED=${12} # 100
...
# NEWMAX_ROIs_final_gm_104_2mm trial-end \
