...
#SBATCH --output=./log/graph-indiv-bin_model-nddSBM_sub-%a_desc-indiv-lvl-estims.out
...
# HOW TO RUN
# sbatch 02c-graph-individual-binary_model-nddSBM_desc-indiv-level-estims.sh \
