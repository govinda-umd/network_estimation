...
def setup_args():
    ...
    args.DATA_UNIT = sys.argv[9] #'sub'
    args.COND = sys.argv[10] #'highT'
    args.GRAPH_IDX = int(sys.argv[11]) #0-69
    args.sbm = sys.argv[12] # a d h o m
    args.dc = sys.argv[13] == 'True'
    args.wait = int(sys.argv[14]) #1200
    args.total_samples = int(sys.argv[15]) #100,000
    args.B = int(sys.argv[16]) #1
    args.gamma = float(sys.argv[17]) #2.0
    args.SEED = int(sys.argv[18]) #100
...
def main():
    ...
    BASE_path = f'/home/govindas/scratch/lab-data/aba'
