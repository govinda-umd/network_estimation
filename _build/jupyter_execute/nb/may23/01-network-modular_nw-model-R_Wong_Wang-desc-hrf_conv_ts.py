...
# # May 17-24, 2023: Reduced Wong Wang model: modular network: HRF convolved time series
...
from netrd.distance import ResistancePerturbation, PortraitDivergence, GraphDiffusion
...
model = eng.simulate_R_Wong_Wang_SDE_model
(
