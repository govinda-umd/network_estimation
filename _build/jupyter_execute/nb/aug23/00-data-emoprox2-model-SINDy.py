...
# ```
# stimulus drives the fMRI signal.
# fMRI signal is noisy, but stimulus is not.
# so tried modeling the stimulus first:
# ```
# $$\dot{u} = f(u)$$
# 
# ```
# equations for the stimulus may guide us at modeling fMRI signal.
# ```
